...
public class Phd extends GraduateStudent{
    ...
    public Phd(String firstName, String secondName, int age, String ID, String owlName, Integer yearOfStudy, String property, String organization) {
        super(firstName, secondName, age, ID, owlName, yearOfStudy, property, organization);
    }

    public Phd(String name, String lastName, int age, String id, String owl, String nickname, String regPassword) {
        super(name, lastName, age, id, owl, nickname, regPassword);
    }

    public Phd(String name, String lastName, int age, String id, String owl, Faculty faculty, String nickname, String regPassword) {
